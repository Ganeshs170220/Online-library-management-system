      ...
      <div class="user-banner">
        ...
        <div class="user-banner-right apply-banner-right">
            ...
            <div class="one">
              ...
              <input class="book-apply-input book" value="<?php echo $_SESSION['studentid']; ?>" id="studentid" type="text" name="studentid"/> 
            </div>
              <div class="two"><label for="studentname">Student Name:</label>
                <input class="book-apply-input" id="studentname"  type="text" name="studentname" value="<?php echo $_SESSION['studentname']; ?>"/>
              </div>
              </div>
            <div class="books-apply">
              <div class="one">
                <label for="studentaadharid">Student Aadhar ID:</label>
                <input class="book-apply-input" id="studentaadharid" value="<?php echo $_SESSION['aadharid']; ?>" type="text" name="aadharid"/></div>
              <div class="two">
              <label for="studentphno">Student phno:</label>
              <input class="book-apply-input" id="studentphno" value="<?php echo $_SESSION['studentphno']; ?>" type="text" name="studentphno"/></div>
            </div> 
            <div class="books-apply">
